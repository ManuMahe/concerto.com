 ...
 */
final class Version20210111093852 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD type_id INT DEFAULT NULL, ADD marque_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP type_id, DROP marque_id');
    }
}
